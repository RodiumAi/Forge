...
```
data/templates/<id>/
├── template.json      # catalog metadata (kind web|mobile, i18n, palette, tags, bootHint)
...
2. Update `template.json` (include `"kind": "web"` or `"mobile"`), `DESIGN.md`, `preview.html`, and `src/App.tsx`.
