...
Liens de planification embarquables.
...
SavvyCal fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).

## Docs officielles

https://savvycal.com/help/embedding
...
```html
<iframe
  src="https://savvycal.com/YOUR_LINK"
...
```text
Ajoute cet embed SavvyCal dans une section Contact de la landing.
