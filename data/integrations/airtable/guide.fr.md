...
Embarquez des vues et bases partagées.
...
Airtable fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).

## Docs officielles

https://support.airtable.com/docs/embedding-a-view-or-base
...
<iframe
  ...
  src="https://airtable.com/embed/YOUR_BASE/YOUR_VIEW?backgroundColor=blue"
  frameborder="0"
  width="100%"
  height="533"
...
```text
Ajoute cet embed Airtable dans une section Contact de la landing.
