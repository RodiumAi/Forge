...
Base no-code avec vues publiques.
...
Baserow fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).
...
```html
<!-- Collez ici le snippet officiel Baserow -->
...
```text
Ajoute cet embed Baserow dans une section Contact de la landing.
