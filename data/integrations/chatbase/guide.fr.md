...
Chatbot IA embarqué pour votre site.
...
Chatbase fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script, iframe).
...
```text
Ajoute cet embed Chatbase dans une section Contact de la landing.
