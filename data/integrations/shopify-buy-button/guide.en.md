...
Buy Button channel embed for products.
...
Shopify Buy Button ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script).
...
/* Paste the Buy Button channel snippet from Shopify admin here.
   It loads https://sdks.shopifycdn.com/buy-button/latest/buy-button-storefront.min.js
   and mounts into #product-component-YOUR_ID */
</script>
```
...
```text
Add this Shopify Buy Button embed in a Contact section on the landing page.
