...
No-code widget marketplace embeds.
...
Elfsight ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script).

## Official docs

https://elfsight.com/help/
...
```html
<!-- Paste the official embed snippet from Elfsight here -->
...
```text
Add this Elfsight embed in a Contact section on the landing page.
