...
Elfsight fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script).
...
```html
<!-- Collez ici le snippet officiel Elfsight -->
...
```text
Ajoute cet embed Elfsight dans une section Contact de la landing.
