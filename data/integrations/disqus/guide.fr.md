...
Script de fils de commentaires.
...
Disqus fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script).

## Docs officielles

https://help.disqus.com/en/articles/1717236-adding-disqus-to-your-site
...
```text
Ajoute cet embed Disqus dans une section Contact de la landing.
