...
Pages de réservation simples à embarquer.
...
TidyCal fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).

## Docs officielles

https://tidycal.com/help/embedding
...
```html
<iframe
  src="https://tidycal.com/YOUR_USER"
...
```text
Ajoute cet embed TidyCal dans une section Contact de la landing.
