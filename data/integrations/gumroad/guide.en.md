...
Overlay checkout for digital products.
...
Gumroad ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script, link).
...
<a class="gumroad-button" href="https://gumroad.com/l/YOUR_PRODUCT">Buy</a>
```
...
```text
Add this Gumroad embed in a Contact section on the landing page.
