...
Widgets embarquables pour sites et boutiques.
...
Common Ninja fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script).

## Docs officielles

https://www.commoninja.com/docs
...
```html
<!-- Collez ici le snippet officiel Common Ninja -->
...
```text
Ajoute cet embed Common Ninja dans une section Contact de la landing.
