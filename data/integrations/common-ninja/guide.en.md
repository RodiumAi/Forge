...
Embeddable widgets for sites and stores.
...
Common Ninja ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script).
...
```html
<!-- Paste the official embed snippet from Common Ninja here -->
...
```text
Add this Common Ninja embed in a Contact section on the landing page.
