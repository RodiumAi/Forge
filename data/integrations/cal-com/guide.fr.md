...
Embarquements de planification open source.
...
Cal.com fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).
...
```text
Ajoute cet embed Cal.com dans une section Contact de la landing.
