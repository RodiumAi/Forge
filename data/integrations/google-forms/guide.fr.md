...
Publiez un formulaire et embarquez-le en iframe.
...
Google Forms fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).
...
```text
Ajoute cet embed Google Forms dans une section Contact de la landing.
