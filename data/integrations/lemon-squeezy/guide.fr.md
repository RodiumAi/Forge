...
Overlay checkout / liens produits.
...
Lemon Squeezy fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script, link).
...
<a href="https://YOUR_STORE.lemonsqueezy.com/checkout/buy/YOUR_VARIANT"
   class="lemonsqueezy-button">Acheter</a>
```
...
```text
Ajoute cet embed Lemon Squeezy dans une section Contact de la landing.
