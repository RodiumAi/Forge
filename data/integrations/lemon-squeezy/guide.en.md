...
Checkout overlay / product links.
...
Lemon Squeezy ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script, link).
...
<a href="https://YOUR_STORE.lemonsqueezy.com/checkout/buy/YOUR_VARIANT"
   class="lemonsqueezy-button">Buy</a>
```
...
```text
Add this Lemon Squeezy embed in a Contact section on the landing page.
