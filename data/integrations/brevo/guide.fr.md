...
Brevo fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script, iframe).
...
```html
<!-- Collez ici le snippet officiel Brevo -->
...
```text
Ajoute cet embed Brevo dans une section Contact de la landing.
