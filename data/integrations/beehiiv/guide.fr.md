...
Embeds d’abonnement newsletter.
...
Beehiiv fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).
...
```html
<!-- Collez ici le snippet officiel Beehiiv -->
...
```text
Ajoute cet embed Beehiiv dans une section Contact de la landing.
