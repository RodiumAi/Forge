...
Lecteur embarqué pour vidéos Vimeo.
...
Vimeo fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).
...
```text
Ajoute cet embed Vimeo dans une section Contact de la landing.
