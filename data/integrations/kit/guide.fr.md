...
Formulaires e-mail créateurs et modales.
...
Kit (ConvertKit) fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script, iframe).

## Docs officielles

https://help.kit.com/en/articles/2502505-how-to-add-a-kit-form-to-your-site
...
```html
<!-- Collez ici le snippet officiel Kit (ConvertKit) -->
...
```text
Ajoute cet embed Kit (ConvertKit) dans une section Contact de la landing.
