...
Creator email forms and modals.
...
Kit (ConvertKit) ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script, iframe).
...
```html
<!-- Paste the official embed snippet from Kit (ConvertKit) here -->
...
```text
Add this Kit (ConvertKit) embed in a Contact section on the landing page.
