...
Google Analytics fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (script).
...
```text
Ajoute cet embed Google Analytics dans une section Contact de la landing.
