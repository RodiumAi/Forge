...
Substack ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (iframe).

## Official docs

https://support.substack.com/hc/en-us/articles/360037554672
...
```html
<!-- Paste the official embed snippet from Substack here -->
...
```text
Add this Substack embed in a Contact section on the landing page.
