...
Substack fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).
...
```html
<!-- Collez ici le snippet officiel Substack -->
...
```text
Ajoute cet embed Substack dans une section Contact de la landing.
