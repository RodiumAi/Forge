...
Open Airtable alternative with share embeds.
...
NocoDB ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (iframe).
...
```html
<!-- Paste the official embed snippet from NocoDB here -->
...
```text
Add this NocoDB embed in a Contact section on the landing page.
