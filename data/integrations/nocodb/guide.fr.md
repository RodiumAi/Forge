...
Alternative open à Airtable avec embeds.
...
NocoDB fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe).
...
```html
<!-- Collez ici le snippet officiel NocoDB -->
...
```text
Ajoute cet embed NocoDB dans une section Contact de la landing.
