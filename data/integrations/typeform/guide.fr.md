...
Formulaires conversationnels via SDK ou iframe.
...
Typeform fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).

## Docs officielles

https://www.typeform.com/developers/embed/
...
```text
Ajoute cet embed Typeform dans une section Contact de la landing.
