...
Formulaires à coller sur n’importe quelle page.
...
Jotform fournit un embed navigateur à coller dans un site React Forge : en général une iframe, une balise script, ou un petit snippet SDK (iframe, script).
...
```text
Ajoute cet embed Jotform dans une section Contact de la landing.
