...
OpenStreetMap ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (iframe).
...
```text
Add this OpenStreetMap embed in a Contact section on the landing page.
