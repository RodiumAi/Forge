...
Conversational widget via install script.
...
Chatbot.com ships a browser embed you can drop into a Forge React site: typically an iframe, a script tag, or a small SDK snippet (script).
...
```text
Add this Chatbot.com embed in a Contact section on the landing page.
