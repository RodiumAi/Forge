...
MESSAGES: dict[Locale, dict[str, str]] = {
    "en": {
        ...
        "slug_reserved": "This name is reserved",
        "slug_purge_failed": "Could not clear the old published site before renaming. Try again in a moment.",
        ...
        "rodium_oauth_binding_required": "This sign-in could not be secured to your browser. Try again in a normal window with storage enabled.",
        "rodium_oauth_required": "Sign in with RodiumAi to continue.",
        "rodium_generate_key_unavailable": "Generating an API key is only available on the official Forge instance. Paste a rd_sk_… key instead.",
    ...
    "fr": {
        ...
        "slug_reserved": "Ce nom est réservé",
        "slug_purge_failed": "Impossible de nettoyer l'ancien site publié avant le renommage. Réessayez dans un instant.",
        ...
        "rodium_oauth_binding_required": "Cette connexion n’a pas pu être sécurisée à votre navigateur. Réessayez dans une fenêtre normale, avec le stockage activé.",
        "rodium_oauth_required": "Connectez-vous avec RodiumAi pour continuer.",
        "rodium_generate_key_unavailable": "La génération de clé API n’est disponible que sur l’instance officielle Forge. Collez une clé rd_sk_… à la place.",
