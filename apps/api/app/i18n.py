...
MESSAGES: dict[Locale, dict[str, str]] = {
    "en": {
        ...
        "connector_managed_oauth": "This connector is linked via Sign in with RodiumAi and cannot be removed.",
        "connector_not_found": "Connector not found",
        "connector_managed_in_settings": "Configure this connector from Settings.",
        "connector_not_configurable": "This connector is not configurable yet.",
        "connector_field_required": "Missing required field: {field}",
        "connector_test_unavailable": "This connector does not support connection tests yet.",
        "connector_resend_fallback": "Resend is not connected. Forge will send from forge@rodiumai.io via SES (25 emails/day).",
        "connector_cloudinary_fallback": "Cloudinary is not connected. Files go to Forge S3 with a 500 MB cap. Connect Cloudinary to remove the limit.",
        "connector_insufficient_rodi": "Insufficient RODI credits for paid operations (email, payments, AI).",
    ...
    "fr": {
        ...
        "connector_managed_oauth": "Ce connecteur est lié via Se connecter avec RodiumAi et ne peut pas être retiré.",
        "connector_not_found": "Connecteur introuvable",
        "connector_managed_in_settings": "Configurez ce connecteur depuis Réglages.",
        "connector_not_configurable": "Ce connecteur n’est pas encore configurable.",
        "connector_field_required": "Champ requis manquant : {field}",
        "connector_test_unavailable": "Ce connecteur ne supporte pas encore les tests de connexion.",
        "connector_resend_fallback": "Resend n’est pas connecté. Forge enverra depuis forge@rodiumai.io via SES (25 emails/jour).",
        "connector_cloudinary_fallback": "Cloudinary n’est pas connecté. Les fichiers vont sur le S3 Forge (plafond 500 Mo). Connectez Cloudinary pour lever la limite.",
        "connector_insufficient_rodi": "Crédits RODI insuffisants pour les opérations payantes (email, paiements, IA).",
