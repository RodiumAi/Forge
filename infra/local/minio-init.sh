...
mc mb -p local/forge-assets
mc mb -p local/forge-uploads
mc mb -p local/forge-runtime

mc anonymous set download local/forge-assets
mc anonymous set download local/forge-runtime
mc anonymous set none local/forge-uploads
